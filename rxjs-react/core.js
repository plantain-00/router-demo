...
var Blog = /** @class */ (function (_super) {
    ...
    Blog.prototype.render = function () {
        ...
        var newPostContentButton = this.state.newPostContent ? React.createElement("button", { "v-if": 'newPostContent', onClick: function () { return _this.addNewPost(); } }, "add new post") : null;
